...
def execute_python(code: str) -> str:
    ...
    postamble = (
        ...
        "    if _figure_numbers:\n"
        "        _saved_count = len(_existing_artifacts)\n"
        "        for _index, _figure_number in enumerate(_figure_numbers, start=_saved_count + 1):\n"
        "            _candidate = _artifact_os.path.join(ARTIFACTS_DIR, f'chart_{_index}.png')\n"
        "            if not _artifact_os.path.exists(_candidate):\n"
